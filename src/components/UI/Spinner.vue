<template>
  <div class="absolute top-1/2 left-1/2">
    <svg 
      aria-hidden="true" role="status" :class="getClass" 
      class="inline animate-spin" viewBox="0 0 100 101" fill="blue" 
    ...
    >
      ...
      <path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 
        ...
        38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="currentColor"/>
    </svg>
  </div>
</template>
...
const getClass = computed (() => {
  return `${colors[props.color] || colors.blue} ${sizes[props.size] || sizes.base}` 
})
