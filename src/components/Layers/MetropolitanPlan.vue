<template>
  <l-layer-group :visible="false" layerType="overlay" name="Plan regulador metropolitano" >
            ...
            .setTooltipContent(
              `<div class='text-sm max-w-lg min-w-[400px]'>
                <div class='flex'>
                  ...
                  <span class='whitespace-pre-line'>${feature.properties.name || '-'}</span>
                </div>
                <div class='flex'>
                  <h1 class='font-semibold pr-1'>Usos permitidos:</h1>
                  <span class='whitespace-pre-line'>
                    ${feature.properties.uperm || '-'}
                  </span>
                </div>
                <div class='flex'>
                  <h1 class='font-semibold pr-1'>Norma:</h1>
                  <span class='whitespace-pre-line'>${feature.properties.norm || '-'}</span>
                </div>
              </div>`
            )
            .openTooltip();
